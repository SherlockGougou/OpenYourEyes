package cc.shinichi.openyoureyesmvp.mvp.v.ui.activity
...
import cc.shinichi.openyoureyesmvp.mvp.v.ui.adapter.HomeDataAdapter
import cc.shinichi.openyoureyesmvp.mvp.v.widget.MyLoadMoreView
                ...
                .getAsync(context, ApiConstant.videoDetailUrl + videoId, object : ApiListener() {
                    override fun success(string: String?) {
                        ...
                        if (data != null) {
                            ...
                            Api.getInstance()
                                    .getAsync(
                                            context, ApiConstant.videoDetailRelateUrl + videoId,
                                            object : ApiListener() {
                                                override fun success(string: String?) {
                                                    super.success(string)
